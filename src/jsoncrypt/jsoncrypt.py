...
from jsoncrypt.logging import OWT_log_msg
...
def OWT_is_master_secret_set() -> bool:
...
def OWT_KDF_bcrypt(secret, domain, len=32, cost : int = 12):
...
class JSONCrypt():
    ...
    def _hkdf(self, secret, len=32, cost=12):
        ...
        return OWT_KDF_bcrypt(secret, b'OpenWebTrust2025', len, cost)
